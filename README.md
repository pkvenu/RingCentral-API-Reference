# RingCentral Platform OpenAPI Specification
[![Build Status](https://travis-ci.org/pkvenu/ringcentral-api-reference.svg?branch=master)](https://travis-ci.org/pkvenu/ringcentral-api-reference)
...
6. If you did everything correct, https://pkvenu.github.io/ringcentral-api-reference/ will lead to your new docs
...
- Documentation(ReDoc): https://pkvenu.github.io/ringcentral-api-reference/
- Look full spec:
    + JSON https://pkvenu.github.io/ringcentral-api-reference/swagger.json
    + YAML https://pkvenu.github.io/ringcentral-api-reference/swagger.yaml
- Preview spec version for branch `[branch]`: https://pkvenu.github.io/ringcentral-api-reference/preview/[branch]
...
1. Run `npm start`
2. Checkout console output to see where local server is started. You can use all [links](#links) (except `preview`) by replacing https://pkvenu.github.io/ringcentral-api-reference/ with url from the message: `Server started <url>`
